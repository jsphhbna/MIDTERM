...
import ApproveSignature from "../src/assets/ApproveSignature.jpg"
import cor_image from "../src/assets/cor_image.jpg"
        ...
        >
          ...
          >
            <tbody>
                    ...
                    <tbody>
                      <tr>
                        <td style={{ width: "20%", textAlign: "center" }}>
                          <img
                            src={EaristLogo || "/placeholder.svg"}
                            alt="Earist Logo"
                            style={{ marginLeft: "25px", width: "150px", height: "110px" }}
                          />
                        </td>
              ...
              <tr>
                <td colSpan={15} style={{ height: "0.3in", fontSize: "62.5%" }}></td>
              </tr>
              <tr>
                <td colSpan={10} style={{ height: "0.1in", fontSize: "55%" }}>
                  <i>
                    <b style={{ fontFamily: "Arial, sans-serif", fontSize: "12px", color: "black" }}>
                      Registration No:&nbsp;
                      <span style={{ color: "red" }}>{certificateData.registration_no}</span>
                    </b>
                  </i>
                </td>
              ...
              <tr>
                ...
                >
                  ...
                  >
                    {ApproveSignature ? (
                      <img
                        src={ApproveSignature || "/placeholder.svg"}
                        alt="Signature"
                        style={{
                          maxWidth: "100%",
                          maxHeight: "100%",
              ...
              <tr>
                <td style={{ width: "20%", textAlign: "center" }}>
                  <img
                    src={FreeTuitionImage || "/placeholder.svg"}
                    alt="EARIST MIS FEE"
                    style={{ marginTop: "10px", width: "200px", height: "150px", marginLeft: "150px" }}
                  />
                </td>
              </tr>
